(function(){
  ...
  core.onload=function(){enhanceExperience();restoreHomeExperienceButtons();addBottomNavigation();};
  core.onerror=function(){enhanceExperience();restoreHomeExperienceButtons();addBottomNavigation();};
